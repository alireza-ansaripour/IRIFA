...
class NGO(models.Model):
    ...
    def get_path(self, filename):
        print(str(filename)+' '+str(self.id))
        return 'NGO/flags/{}/{}'.format(self.latin_name, str(filename))
    ...
    flag = models.ImageField(verbose_name='پرچم', upload_to = get_path)
...
@receiver(pre_delete, sender=NGO)
def NGO_delete(sender, instance, **kwargs):
    print('in Ngo delete: '+str(instance)+' '+str(instance.flag))
